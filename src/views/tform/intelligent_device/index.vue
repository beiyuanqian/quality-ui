        ...
        <el-row>
          ...
          <el-col>
            <el-form-item label="控制器型号及编码" prop="system_name_version_number">
              <el-input v-model="form.system_name_version_number" placeholder="例：TS008 30001406xxxx"
            ...
            <el-form-item label="程序名称及编码" prop="user_password">
              <el-input v-model="form.user_password"
                        placeholder="例:app_MP_sdk#####_1.0.2.0_2a83aca8-806b310dfb5193c85a51da7fa05dxxxx.bin"
          ...
          <el-col>
            ...
            <el-form-item label="校验码" prop="project_system_address">
              <el-input v-model="form.project_system_address" placeholder="例：2a83aca8-806b310dfb5193c85a51da7fa05dxxxx"
                        style="width: 570px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            ...
            <el-form-item label="修改时间" prop="database_user_password">
              ...
              <el-date-picker v-model="form.database_user_password" clearable type="date" placeholder="选择日期"
                              style="width: 570px"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="芯片型号及编码" prop="computer_version">
              <el-input v-model="form.computer_version" placeholder="例：IC RTL8762C36000106xxxx"
                        style="width: 480px"></el-input>
            </el-form-item>
            <el-form-item label="烧写器及所选芯片型号" prop="project_server_address">
              <el-input v-model="form.project_server_address" placeholder="例：USB转TTLPLxxxx"
                        style="width: 570px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            ...
            <el-form-item label="芯片DATASHEET容量大小" prop="database_summary_design">
              <el-input v-model="form.database_summary_design" placeholder="例：160KB SRAM"
                        style="width: 570px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
          ...
          <el-col>
            ...
            <el-table :data="tableData" style="width: 100%" fit highlight-current-row>
              ...
              <el-table-column label="操作" width="80px">
                <template slot-scope="scope">
                  <el-button @click="handleDelete(scope.$index)" type="text" size="mini" icon="el-icon-delete">删除
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
          ...
          <el-col>
            ...
            <el-form-item label="总功能数" prop="function_number">
              <el-input v-model="form.function_number" placeholder="(以“功能说明”的数量为统计个数的依据)"
                        style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-row v-for="(item, index) in functionInfo.functionsArray">
              <el-col>
                ...
                <el-button v-if="index!=0" style="margin-left: 5px" icon="el-icon-delete"
                           @click="delDays(index)"></el-button>
                <el-button v-if="index == 0" style="margin-left: 5px" icon="el-icon-document-add"
                           @click="addDays()"></el-button>
              </el-col>
            </el-row>
          </el-col>
