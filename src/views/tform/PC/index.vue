    ...
    <el-card shadow="always">
      ...
      <el-form ref="form" :model="form" :rules="rules" :inline="true" :label-position="labelPosition" label-width="250px">
        <el-row>
          ...
          <h3>APP测试申请信息</h3>
          <el-col>
            <el-form-item label="软件包名" prop="system_name_version_number">
              <el-input v-model="form.system_name_version_number" placeholder="请输入软件包名" style="width: 450px"></el-input>
            </el-form-item>
            <el-form-item label="版本号" prop="user_password">
              <el-input v-model="form.user_password" placeholder="请输入版本号" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="MD5效验码" prop="supporting_facility">
              <el-input style="width: 450px" placeholder="请输入MD5效验码"></el-input>
            </el-form-item>
            <el-form-item label="字节数" prop="project_system_address">
              <el-input v-model="form.project_system_address" placeholder="请输入字节数" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="修改时间" prop="database_type_address">
              <el-input v-model="form.database_type_address" placeholder="请输入修改时间" style="width: 450px"></el-input>
            </el-form-item>
            <el-form-item label="测试账户与密码" prop="database_user_password">
              <el-input v-model="form.database_user_password" placeholder="请输入测试账户与密码" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
          ...
          <h3>软件首次送测按送测单填写，项目测试过程中修改版本交予测试时按照下方内容填写并邮件同步给测试</h3>
          <el-col>
            <table style="width: 800px;background-color:#CCC">
              <tr>
                <td colspan="4">系统/信息</td>
                <td colspan="8">windows</td>
              </tr>
              <tr>
                <td colspan="4">PC软件名称</td>
