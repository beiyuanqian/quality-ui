  ...
  <div class="app-container">
    <el-card shadow="always">
      <div slot="header" class="clearfix">
        <h1>APP项目测试申请单</h1>
        <p style="line-height: 0;font-size: smaller;color: red">（注：项目如有涉及WEB端、控制器、小程序的请按对应模板一并填写多个送测单）
          申请日期：
        ...
        <el-row>
          ...
          <el-col>
            <el-form-item label="迭代内容" prop="iteration_content" >
              <el-input type="textarea" style="width: 690px" :autosize="{minRows: 1}" v-model="form.iteration_content" placeholder="请输入迭代内容"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="需求规格说明书PLM编号" prop="specification_number">
              <el-input v-model="form.specification_number" placeholder="请输入需求规格说明书PLM编号" style="width: 450px"></el-input>
            </el-form-item>
          ...
          <el-col>
            ...
            <el-form-item label="APP获取方式" prop="project_bug_address">
              <el-input v-model="form.project_bug_address" placeholder="可提供下载连接或网盘、邮件等形式" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
          ...
          <h3>APP测试申请信息</h3>
          <el-col>
            <el-form-item label="APP包名" prop="system_name_version_number">
              <el-input v-model="form.system_name_version_number" placeholder="Android：     IOS：		" style="width: 450px"></el-input>
            </el-form-item>
            <el-form-item label="APP版本号" prop="user_password">
              <el-input v-model="form.user_password" placeholder="Android：     IOS：		" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="APK的MD5效验码" prop="supporting_facility">
              <el-input style="width: 450px" placeholder="Android：     IOS：		"></el-input>
            </el-form-item>
            <el-form-item label="APK字节数" prop="project_system_address">
              <el-input v-model="form.project_system_address" placeholder="Android：     IOS：		" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="APK修改时间" prop="database_type_address">
              <el-input v-model="form.database_type_address" placeholder="Android：     IOS：		" style="width: 450px"></el-input>
            </el-form-item>
            <el-form-item label="测试账户与密码" prop="database_user_password">
              <el-input v-model="form.database_user_password" placeholder="Android：     IOS：		" style="width: 450px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
          ...
          <el-col>
            <el-form-item label="上一版本APK获取方式" prop="computer_version">
              <el-input v-model="form.computer_version" placeholder="如无上一版可忽略该项" style="width: 690px"></el-input>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="APP升级方式（可多选）" prop="a">
              <el-radio v-model="form.a" label="1">手动下载安装升级</el-radio>
              <el-radio v-model="form.a" label="2">静默下载升级</el-radio>
              <el-radio v-model="form.a" label="3">推送升级提示，用户确认后下载升级</el-radio>
              <p>
                <el-input type="textarea" style="width: 690px" :autosize="{minRows: 1}" placeholder="备注：请备注升级环境为仅wifi or 数据网络下 or 不做限制，并如何提示用户升级（红点提示/弹框提示等），如需求有详细描述可跳过该备注。"></el-input>
              </p>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item label="配套设施" prop="supporting_facility">
              ...
              <p v-if="form.supporting_facility==1">
                <el-input type="textarea" style="width: 690px" :autosize="{minRows: 1}" placeholder="请输入配套设施"></el-input>
              </p>
            </el-form-item>
          </el-col>
          ...
          <el-col>
            <table style="width: 800px">
              <tr>
                <td colspan="12" style="background-color:#CCC">
                  App首次送测按送测单填写，项目测试过程中修改版本交予测试时按照下方内容填写并邮件同步给测试
                </td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">系统/信息</td>
                <td colspan="8">Android</td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">APP名称</td>
                <td colspan="8">格力掌上通</td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">程序包名</td>
                <td colspan="8">com.hctforgreen.greenservice</td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">版本号</td>
                <td colspan="8">2.4.8</td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">效验码（MD5）</td>
                <td colspan="8">82745D67C3BA4A3DB2FE0A61EB204769</td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">字节数</td>
                <td colspan="8">20523113</td>
              </tr>
              <tr style="background-color:#CCC">
                <td colspan="4">修改时间</td>
                <td colspan="8">2020年5月28日, 17:46:11</td>
              </tr>
            </table>
          </el-col>
          <el-col>
