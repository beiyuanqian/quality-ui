    ...
    data() {
      return {
        ...
        rules: {
          ...
          machine_category: [{required: true, message: '请输入机型类别', trigger: 'change'}],
          machine_name: [{required: true, message: '请输入机型名称', trigger: 'change'}],
          machine_num: [{required: true, message: '请输入涉及台数', trigger: 'change'}],
          question_broad: [{required: true, message: '请输入问题大类', trigger: 'change'}],
          question_slender: [{required: true, message: '请输入问题细类', trigger: 'change'}],
